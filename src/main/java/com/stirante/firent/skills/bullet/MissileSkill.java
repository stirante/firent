...
import com.stirante.firent.effects.MissileEffect;
...
public class MissileSkill extends Skill {
    @Override
    protected SkillActivationResult performSkill(MagicPlayer player) {
        player.addEffect(new MissileEffect(player));
    ...
    public ArrayList<String> getDescription() {
        return StringUtils.asList("Odpala samonaprowadzające rakiety w kierunku pobliskich wrogów");
    }
}
